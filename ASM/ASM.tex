...
In die Formel \ref{eq:Kurzschlusswiderstand} einsetzen:
...
Die Streureaktanzen $X_{1\sigma}$ und $X_{2\sigma}^\prime$ werden errechnet:
...
\begin{equation}
    R_{1_{55}} = R_{1_{20}} \cdot \dfrac{55^\circ \si{C} + 235^\circ \si{C}}{20^\circ \si{C} + 235^\circ \si{C}} = 2,64 \Omega
\end{equation}
...
\subsubsection{Maschinenparameter der Parallelschaltung aus $X_h$ und $R_{Fe+Reib}$ aufgrund der Leerlaufmessung}
...
Der eben berechnete Wert hat eine Abweichung von wenigen Prozent im Vergleich zu dem in Kapitel I. gemessenen Drehmoment von 30,6Nm, dies lässt
...
\input{tables/drehmomente_vergleichen.tex}
\input{tables/moment_ueber-n_vergleichen.tex}
...
\input{tables/U2_ueber-f2_vergleichen.tex}
