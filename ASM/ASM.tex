...
Die gemessenen Leerlaufleistungen P_{0} beinhalten Cu}, P_{Reib} und P_{Fe}. Um die Eisen- 
und Reibungsverluste zu trennen, werden als Erstes die Kupferverluste P_{Cu} abgezogen.\\
P_{0} - P_{Cu} = P_{Reib+Fe} 

\input{./tables/trennung_eisen_reib.tex}

Zur graphischen Ermittlung von P_{Reib} werden die Messwerte für P_{Reib+Fe} nun graphisch als 
Funktion der quatratischen Spannung U² dargestellt.
